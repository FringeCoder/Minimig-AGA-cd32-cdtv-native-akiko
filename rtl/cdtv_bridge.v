...
(
	...
	// Exact "nothing staged" flag. The save state sequencer will not freeze
	// while a sector is part-way through the FIFO, and the 32-byte rounding
	// a credit counter would use is not precise enough to decide that.
...
assign sec_fifo_empty = (sec_avail == 13'd0);
