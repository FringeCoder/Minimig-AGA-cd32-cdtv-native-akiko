...
// NOTE: this is upstream's combinational decode, restored 2026-08-03.
// It was retimed into a registered one-hot mask to buy 185 ps of setup slack,
// and the transform was verified exhaustively as logically equivalent -- but
// on hardware the external drive then never responded, while RobSmithDev's
// build worked on the same board. Every other floppy module here is
// byte-identical to his, so this hunk was the only variable. Correctness wins;
// the timing problem gets solved a different way.
